...
def get_device_icon(model, dev_type):
    ...
    if 'light' in model_lower or 'lamp' in model_lower or dev_type == 'light':
        ...
        return 'curtain'
    elif 'airc' in model_lower or 'aircondition' in model_lower or dev_type == 'ac':
        return 'ac'
    elif 'sensor' in model_lower or 'miaomiaoce' in model_lower or dev_type == 'sensor':
        return 'sensor'
    elif 'plug' in model_lower or 'outlet' in model_lower or dev_type == 'plug':
        return 'plug'
    elif 'switch' in model_lower or dev_type == 'switch':
        return 'switch'
    elif 'wifispeaker' in model_lower or 'speaker' in model_lower or 'audio' in model_lower:
        return 'speaker'
    elif 'router' in model_lower or 'miwifi' in model_lower:
        return 'router'
